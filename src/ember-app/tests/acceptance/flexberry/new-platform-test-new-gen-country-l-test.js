...
moduleForAcceptance('[AGAT] Acceptance | new platform test new gen country l');

test('testing new-platform-test-new-gen-country-l', function(assert) {
  visit('/new-platform-test-new-gen-country-l');
