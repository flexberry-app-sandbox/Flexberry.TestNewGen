...
moduleForAcceptance('[AGAT] Acceptance | new platform test new gen language l');

test('testing new-platform-test-new-gen-language-l', function(assert) {
  visit('/new-platform-test-new-gen-language-l');
