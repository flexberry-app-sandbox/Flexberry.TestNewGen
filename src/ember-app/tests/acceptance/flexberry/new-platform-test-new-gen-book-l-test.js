...
moduleForAcceptance('[AGAT] Acceptance | new platform test new gen book l');

test('testing new-platform-test-new-gen-book-l', function(assert) {
  visit('/new-platform-test-new-gen-book-l');
