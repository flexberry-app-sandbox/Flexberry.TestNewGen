...
moduleForAcceptance('[AGAT] Acceptance | new platform test new gen author l');

test('testing new-platform-test-new-gen-author-l', function(assert) {
  visit('/new-platform-test-new-gen-author-l');
